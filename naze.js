...
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'ping', buttonText: { displayText: '🔎ping' }, type: 1 }]
            ...
            case 'sponsor': {
            if (!m.isGroup) throw mess.group
            let qontak = `60102810046@s.whatsapp.net`
let dana = `6102810046@s.whatsapp.net`
...
let getcontact = `60102810046@s.whatsapp.net`
 ...
 break
            ...
            let kukiw = `*Kak ${pushname}*`
	           ...
	           rows: [
                ...
                {title: "✦  「 Downloader 」", rowId: `mdownloader`, description: `╰ ► 📥Buat Download mp3/mp4? `},
...
│
╰─────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Ownerメ' }, type: 1 }]
